...
import (
	...
	"github.com/iprodev/3x-ui/v2/util/json_util"
...
type Inbound struct {
	...
	TrafficCoefficient   float64              `json:"trafficCoefficient" form:"trafficCoefficient" gorm:"default:1"`                                   // Traffic multiplier (0 = use global)
