...
update_menu() {
    ...
    wget --no-check-certificate -O /usr/bin/x-ui https://raw.githubusercontent.com/iprodev/3x-ui/main/x-ui.sh
...
update_shell() {
    wget -O /usr/bin/x-ui -N --no-check-certificate https://github.com/iprodev/3x-ui/raw/main/x-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
